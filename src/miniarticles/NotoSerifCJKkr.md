...
Noto Serif CJK KR is a modulated (“serif”) design for the _Korean_ language using _Hangul_ and the _Korean Hanja_ scripts. It covers all Hanja characters from the Basic Multilingual Plane of the Unicode Standard, and some additional ones. It also supports _Hiragana, Katakana, Latin, Cyrillic_ and _Greek_. 
